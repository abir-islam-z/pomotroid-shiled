...
pub struct Settings {
    ...
    pub system_block_enabled: bool,
    pub system_adult_shield_enabled: bool,
...
pub fn load(conn: &Connection) -> Result<Settings> {
    ...
    Ok(Settings {
        ...
        hide_dock_icon: parse_bool(&map, "hide_dock_icon", d.hide_dock_icon),
        ...
        system_block_enabled: parse_bool(&map, "system_block_enabled", d.system_block_enabled),
        system_adult_shield_enabled: parse_bool(&map, "system_adult_shield_enabled", d.system_adult_shield_enabled),
